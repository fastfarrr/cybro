...
class StudentReportWizard(models.TransientModel):
    ...
    def action_report_create(self):
        ...
        from hostel_room as hr inner join student_details as st on hr.id = st.room_id inner join account_move as am on am.student_id = st.id group by hr.id,st.id"""
